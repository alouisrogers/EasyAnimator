 ...
 * it.
 *
 * <p></p> listener keeps three maps, one each for key typed, key pressed and key released Each map
 ...
 *
 * <p></p>This class implements the KeyListener interface, so that its object can be used as a valid
 * keylistener for Java Swing.
 */
public class KeyboardListener extends Component implements KeyListener {
